    ...
    <div class="row">
      <div class="col-md-12">
        <ul class=" container kitchen card my-2">
          ...
          <li class="inlineshop text-danger">Service</li> 
        </ul>
      </div>
...
while ($row_services=mysqli_fetch_array($run_services)) {
 ...
 <div class="col-md-4 card">
   <img src="admin_area/services_images/<?php echo $service_image; ?>" class="img-fluid  img-thumbnail">
   <h3 class="text-center"><?php echo $service_title; ?></h3>
   <p>
     <?php echo $service_desc; ?>
   </p>
   <div class="text-center">
     <a href="<?php echo $service_url?>" class="btn btn-info">
