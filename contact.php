  ...
  <div class="container">
    ...
    <div class="row">
      ...
      $contact_email=$row_contact_us['contact_email'];
             ?>
            <h3 class="text-center"><?php echo $contact_heading?></h3>
            <p class="text-center"><?php echo $contact_desc?></p>
          </div>
          <div class="card-body">
      ...
      <div class="input-group mb-2">
        ...
        <input type="text" class="form-control" id="inlineFormInputGroup" placeholder="Username" name="name" required>
      </div><!--single field-->
      <div class="input-group mb-2">
        <div class="input-group-prepend">
      ...
      <div class="input-group mb-2">
        ...
        <textarea type="text" class="form-control" id="inlineFormInputGroup" placeholder="Message" name="message"></textarea>
      </div><!--end of the single input-->
       <div class="input-group mb-2">
        <div class="input-group-prepend">
          <div class="input-group-text"><i class="far fa-comments"></i></div>
...
while ($row_inquiry_types=mysqli_fetch_array($run_inquiry_types)) {

$inquiry_title=$row_inquiry_types['inquiry_title'];
echo "<option>$inquiry_title</option>";
}
          ?>
        </select>
      </div><!--end of the single input-->
      <div class="text-center">
        ...
        if (isset($_POST['submit'])) {
         #admin recieves emails...
          ...
          $new_message="
<h3>This Message Has bern sent by $sender_name</h3>
<p><b>Sender Email: </b><br>$sender_email</p>
<p><b>Sender Subject: </b><br>$sender_subject</p>
<p><b>Sender Inquiry Type: </b><br>$inquiry_type</p>
<p><b>Sender Message: </b><br>$sender_message</p>
          ";
          $headers="From $sender_email \r\n";
          $headers .="Content-type: text/html\r\n";
          mail($contact_email,$sender_subject,$new_message,$headers);
          #Send the email to sender throught this query
          $email = $_POST['email'];
          $subject = "Welcome to my website";
          $msg =" Thank you friend, i will get to you soon!";
          $from = "simpledaniel.1818@gmail.com";
          mail($email,$subject,$msg,$from);
          echo "<script>alert('The Message sent successifully!')</script>";
        }
            ?>
