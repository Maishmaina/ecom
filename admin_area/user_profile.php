...
<div class="row">
	<div class="col-md-12">
		<ol class="breadcrumb">
			<li class="active">
			<i class="fa fa-tachometer-alt fa-1x"></i>&nbsp;Dashboard/ Edit Profile.
			</li>
		</ol>
	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header">
					<h3 class="card-title">
						<i class="fas fa-calendar-plus"></i>&nbsp;Edit Profile
					</h3>
				...
				<div class="card-body">
					<form action="" method="post" class="form-holizontal" enctype="multipart/form-data">
						...
						<div class="col-md-6">
							<input type="text" name="admin_pass" class="form-control" value="<?php echo $admin_pass;?>" required>
						</div>
						</div>
						<div class="form-group row">
						<label class="col-md-3">User County:</label>
						<div class="col-md-6">
							<input type="text" name="admin_county" class="form-control" value="<?php echo $admin_county;?>" required>
						</div>
						</div>
						<div class="form-group row">
						...
						<div class="col-md-6">
							...
							<br><img src="admin_images/<?php echo $admin_image;?>" alt="" style="height: 50px; width: 50px;">
						</div>
						</div>
						<div class="form-group row">
						<label class="col-md-3"></label>
						<div class="col-md-6">
							<input type="submit" name="update" value="Update User" class="btn btn-success" required>
						</div>
						</div>
					</form>
				</div>
  ...
  if (isset($_POST['update'])) {
   ...
   $admin_image=$new_admin_image; 		
    ...
    $run_admin =mysqli_query($con,$update_admin);
     if ($run_admin) {
     	echo "<script>alert('Admin Updated Successifully Please LogIn again')</script>";
