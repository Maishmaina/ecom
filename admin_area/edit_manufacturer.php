...
<div class="row">
	<div class="col-md-12">
		<ol class="breadcrumb">
			<li>
				<i class="fa fa-tachometer-alt fa-1x"></i>&nbsp;Dashboard/ Edit Manufacturer
			</li>
		</ol>
	</div><!--end col-md-12-->
</div>
		...
		<div class="card-body">
			<form action="" method="post" class="form-holizontal" enctype="multipart/form-data">
				<div class="form-group row">
					...
					<div class="col-md-6">
						<input type="radio" name="manufacturer_top" value="yes" <?php if ($m_top=='no'){}else{echo "checked='checked'";}?>>
						<label>Yes</label>
					...
					<div class="col-md-6">
						<input type="file" name="manufacturer_image" class="form-control"><br>
						<img src="other_images/<?php echo $m_image?>" width='50px' height='50px'>
					</div>
				</div>
					<div class="form-group row">
					<label class="col-md-3 control-label"></label>
					<div class="col-md-6">
						<input type="submit" name="update" class="form-control btn btn-success" value="Update Manufacturer">
					</div>
				</div>
			</form>
		</div>
...
<?php
 if (isset($_POST['update'])) {
 	...
 	if ($run_manufacturer) {
 		echo "<script>alert('Manufacturer Updated Successifully')</script>";
