...
<div class="row">
	<div class="col-md-12">
		<ol class="breadcrumb">
			<li class="active">
			<i class="fa fa-tachometer-alt fa-1x"></i>&nbsp;Dashboard/ View Coupons.
			</li>
		</ol>
	</div>
	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header">
				<h3 class="card-title">
					<i class="fas fa-american-sign-language-interpreting"></i>&nbsp; View Coupons
				</h3>
          ...
          $i++;
					...
					<tr>
                        ...
                        <td>
        		<a class="btn btn-danger" href="index.php?delete_coupon=<?php echo $coupon_id?>"><i class="fas fa-trash"></i>Delete
        		
        	</a>
        	</td>
        	<td>
        		<a class="btn btn-info" href="index.php?edit_coupon=<?php echo $coupon_id?>"><i class="fas fa-edit"></i>Edit
