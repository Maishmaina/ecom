...
<body>
 <div class="container-fluid">
	<div class="row">
		<div class="col-md-12">
			<ol class="breadcrumb">
				<li class="active"><i class="fas fa-tachometer-alt"></i> Dashboard /Insert Product</li>
			</ol>
	...
	<div class="col-md-12">
		<div class="card ">
			<div class="card-header">
				<h3 class="card-title"><i class="fas fa-money-bill-alt"></i> Insert Product</h3>
			</div>
...
<div id="video" class="tab-pane fade show" role="tabpanel" aria-labelledby="v-pills-home-tab">
    <textarea class="form-control" name="product_video" ></textarea>         
					...
					<div class="form-group row">
						...
						<div class="col-md-6">
							<input type="submit" name="submit" value="Insert Product" class="btn btn-success form-control">
						</div>
					</div><!--end of the single item-->
...
if ($run_product) {
	echo"<script>alert('Product Inserted Successifully')</script>";
	echo"<script>window.open('insert_product.php','_self')</script>";

}
else{
 
   echo"<script>alert('Something went wrong! product not inserted')</script>";
