...
<div class="row">
	<div class="col-md-12">
		<ol class="breadcrumb">
			<li>
				<i class="fa fa-tachometer-alt fa-1x"></i>&nbsp;Dashboard/ Edit Products Category.
			</li>
		</ol>
	</div><!--end col-md-12-->
</div><!--end of the row-->
<div class="row">
	<div class="col-md-12">
		<div class="card">
			...
			<h3 class="card-title">
				<i class="fas fa-money-bill-alt"></i>&nbsp;Edit Product Category
			</h3>
		...
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-md-6">
					...
					<img src="other_images/<?php echo $p_cat_image;?>" width="50px" height="50px">
				</div>
			</div>
			<div class="form-group row">
...
<?php 
 if (isset($_POST['update'])) {
 	...
 	if ($run_p_cat) {
 		echo "<script>alert('Product Category Updated Successifully');</script>";
