...
<body>
 <div class="container-fluid">
	<div class="row">
		<div class="col-md-12">
			<ol class="breadcrumb">
				<li class="active"><i class="fas fa-tachometer-alt"></i> Dashboard /Edit Bundle</li>
			</ol>
	...
	<div class="col-md-12">
		<div class="card ">
			<div class="card-header">
				<h3 class="card-title"><i class="fas fa-money-bill-alt"></i> Edit Bundle</h3>
			</div>
			<div class="card-body">
    ...
    <textarea class="form-control" name="product_video" rows="10" cols="15" >
    	  		<?php echo $p_video;?>
					...
					<div class="form-group row">
						...
						<div class="col-md-6">
							<input type="submit" name="update" value="update Bundle" class="btn btn-success form-control">
						</div>
					</div><!--end of the single item-->
